        ...
        <div className="cont">
            <div className='main' >
                <div className='first'>
                    ...
                    <Typography variant="body1" style={{ color: 'textSecondary' }}>{moment(post.createdAt).fromNow()}</Typography>
            ...
            {!!recommendedPosts.length && (
                <div className='sect'>
                    <Typography gutterBottom variant="h5" style={{ color: '#c8102e' }}>You might also like</Typography>
